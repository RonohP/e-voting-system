            ...
            <div className="maincontainer">
                ...
                <div className='flex mx-20 my-20 flex-row'>
                    ...
                    <div className='right w-1/2 h-auto p-2 mt-20'>
                        ...
                        Welcome back to the women techsters University voting 
                        platform, Sign in to vote in your preffered candidate.
                        </p>
                        <div className='p-2'>
                            ...
                            <span>
                            <Link className=' forget-password mx-20 text-right px-20 font-bold' to='/'>
                              Forget Password?
